...
For Windows, download the `.exe` asset with the same version number as the macOS package. The Windows build is generated by the repository's Windows GitHub Actions workflow.
